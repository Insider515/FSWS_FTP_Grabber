...
// Перевіряємо наявність авторизації користувача
session_start();
                    ...
                    <div class="col w-auto" style="margin: 0 auto;">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            ...
                            <div class="card-body" style="text-align: left;">
                                ...
                                <form enctype="multipart/form-data" method="post" action="/assets/php/send_file.php<?php echo $params; ?>">
                                    <div class="p-2">
                        ...
                        <div class="card mb-4 rounded-3 shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <th>Видалення</th>
                                        ...
                                        <?php if (isset($query['folder'])) {
                                            echo '<tr><td><span style="cursor:pointer;" onclick="history.back();">..</span></td><td></td></tr>';
                                        } ?>
                                        <?php
                                        foreach ($items as $arrays) {
                                            ...
                                            if ($arrays['type'] == 'directory') {
                                                ...
                                                echo "<tr><td><a href='/assets/php/index.php?folder=$folderName'><img src='/assets/img/folder.svg'><input class='file_' style='background-color: transparent;border: 0;color: black;' type='submit' name='submit' value='$folderName' data-toggle='tooltip' data-placement='top' title='Просмотр'/></a></td>" .
                                                    "<td>";
                                                if ($folderName == '..') {
                                                    echo "<form method='post' style='margin-left: 3rem;' action='/assets/php/folder_remove.php'><li class='trash'><input class='file_r' type='submit' name='submit' value='$folderName' data-toggle='tooltip' data-placement='top' title='Видалення'/></li></form>";
                                                }
                                                echo "</td></tr>";
                                            } else {
                                                $fileName = $arrays['name'];
                                                echo "<tr><td><form method='post' action='/assets/php/get_file.php'><img src='/assets/img/txt.svg'><input class='file_' style='background-color: transparent;border: 0;color: black;' type='submit' name='submit' value='$folder_$fileName' data-toggle='tooltip' data-placement='top' title='Просмотр'/></form></td>" .
                                                    "<td><form method='post' style='margin-left: 3rem;' action='/assets/php/remove_file.php'><li class='trash'><input class='file_r' type='submit' name='submit' value='$folder_$fileName' data-toggle='tooltip' data-placement='top' title='Видалення'/></li></form></td></tr>";
                                            }
                                        }
                                        ?>
                                    </table>
